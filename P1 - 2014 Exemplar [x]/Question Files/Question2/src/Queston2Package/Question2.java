...
public class Question2 extends javax.swing.JFrame {
    ...
    RelayEvent Boys19Relay = new RelayEvent("Boys U/19 4x100m Relay", "Bristol House", "2009", 41.13);
    ...
    private void btnQ2_2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQ2_2ActionPerformed
        String team = txfTeam.getText();
        double newTime = 0;
        boolean validation = false;
            try {
                newTime = Double.parseDouble(txfTime.getText());
                validation = true;
        ...
        if (validation == true) {
        Boys19Relay.checkForRecord(team, newTime);
        }
    ...
    private void btnQ2_3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQ2_3ActionPerformed
       String output = "";
        if (Boys19Relay.getYear().contains("2013") || Boys19Relay.getYear().contains("2014") || Boys19Relay.getYear().contains("2015")) {
           output = Boys19Relay.toString() + "\n" + "\n" + "Recent record.";
       } else {
           output = Boys19Relay.toString() + "\n" + "\n" + "Old record.";
       }
       txaQ2.setText(output);
