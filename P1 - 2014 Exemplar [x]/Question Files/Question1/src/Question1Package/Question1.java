...
public class Question1 extends javax.swing.JFrame {
    ...
    private void btnQuest1_1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuest1_1ActionPerformed
        lblHeading.setText("PC Athletics Championship");
    ...
    private void btnQuest1_2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuest1_2ActionPerformed
        txaNameTag.setText(this.createNameTag(txfID.getText(), txfFullNames.getText(), txfSurname.getText()));
    ...
    private void btnQuest1_3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuest1_3ActionPerformed
        btnQuest1_2ActionPerformed(evt);
        txaNameTag.append("\n" + calculateAgeGroup(txfID.getText()));
    ...
    private void btnQuest1_4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnQuest1_4ActionPerformed
        txaQ1.setText(calculatePayments(Integer.parseInt(JOptionPane.showInputDialog(null, "Enter amount of items purchased")), Double.parseDouble(JOptionPane.showInputDialog(null, "Enter price of items purchased"))));
    ...
    public String calculatePayments(int amtItems, double priceOfItems) {
        int fullPriceItems;
        int discountedItems;
        String output = "Quantity  " + "  Price  " + "  Total  " + "  Discount  " + "  Amount Due ";
        for (int i = 1; i < amtItems + 1; i++) {
            if (i == 1) {
                discountedItems = 0;
                fullPriceItems = 1;
            } else {
                fullPriceItems = i % 2;
                discountedItems = i - fullPriceItems;
            }
            double total = i * priceOfItems;
            double discount = (discountedItems * priceOfItems) * 20 / 100;
            double totalDue = total - discount;
            output = output + "\n" + (i) + "x" + priceOfItems + " = " + total + "  " + discount + "  " + totalDue;
        }
        return output;
    }

    public String calculateAgeGroup(String id) {
        int birthYear = Integer.parseInt(id.substring(0, 2));
        int age = 114 - birthYear; // Basically saying 2014 - bith year
        String ageGroup = "u/";
        if (age <= 15) {
            ageGroup = ageGroup + "15";
        } else if (age > 15 && age <= 17) {
            ageGroup = ageGroup + "17";
        } else if (age > 17 && age <= 19) {
            ageGroup = ageGroup + "19";
        } else {
            ageGroup = "Not eligible to participate";
        }
        String output = "Age group: " + ageGroup;
        return output;

    }

    public String createNameTag(String id, String firstName, String surname) {
        ...
        int genderID = Integer.parseInt(id.substring(6, 10));
        String gender = "";
        if (genderID < 5000) {
            gender = "Female";
        } else {
